...
describe('Test for render', () => {
    ...
    it('Should return a string for the corresponding SVG file with the given shape color', () => {
        const svg2 = "<svg version='1.1' width='300' height='200' xmlns='http://www.w3.org/2000/svg'><polygon points='150,20 50,180 250,18' fill='blue' /><text x='150' y='125' font-size='60' text-anchor='middle' fill='green'>ABC</text></svg>";
